...
注: 本データセットでは発電量を GHI から生成しているため、GHI と目的変数の関連が非常に強い構造となっている。この特性を踏まえたうえで、実務において日射量が重要な説明変数であることを考慮し、本プロジェクトでは GHI を特徴量として採用した。  
なお、実績値を用いた電力需要予測を別リポジトリ [ml-lab](https://github.com/usapyon549/ml-lab) にまとめている。
