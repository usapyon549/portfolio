...
また、`マネジメント層ではなく現場を志望`しているため、  
現場でおこりうる下記を考慮した設計をしています。
...
- SageMaker Serverless Endpoint へのデプロイ
- Banking Marketing Dataset を用いた不均衡データ分類
- LLM + RAG による Portfolio Assistant 構築
